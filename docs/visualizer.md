...
- system logic
- regularBPMN and simBPMN custom elements
...
The Projects page can import existing simBPMN/simpleXflow model files from the browser. Supported formats are:
